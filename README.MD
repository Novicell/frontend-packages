...
#### Common scripts
To be able to run these scripts, **you are required to have bash installed on your system and available in your `PATH` variable.**
...
To quickly reset all dependencies and builds, you can run:
```bash
